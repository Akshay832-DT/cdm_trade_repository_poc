...
class MarginCallResponse(CdmModelBase):
    ...
    margin_call_response_action: List[ForwardRef("MarginCallResponseAction")] = Field(None, description="Specifies the margin call action details, including collateral to be moved and direction.")
    margin_response_type: ForwardRef("MarginCallResponseTypeEnum") = Field(description="Indicates the response type, such as, is the margin call response a 'full' 'part' agreement or 'dispute'.")
    agreed_amount_base_currency: ForwardRef("Money") = Field(description="Indicates the amount that posting entity agrees to remit in response to margin call (in base currency).")
...
from src.models.cdm.generated.metafields.reference_with_meta_collateral_portfolio import ReferenceWithMetaCollateralPortfolio
from src.models.cdm.generated.observable.asset.money import Money
MarginCallResponse.model_rebuild()
