...
class MarginCallBase(CdmModelBase):
    ...
    instruction_type: ForwardRef("MarginCallInstructionType") = Field(description="Identifies the enumeration values to specify the call notification type, direction, specific action type.")
    ...
    call_agreement_type: ForwardRef("AgreementName") = Field(description="Specifies the legal agreement type the margin call is generated from and governed by.")
    ...
    reg_margin_type: ForwardRef("RegMarginTypeEnum") = Field(description="Identifies margin type and if related regulatory mandate")
