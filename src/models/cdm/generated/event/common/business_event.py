...
class BusinessEvent(CdmModelBase):
    ...
    event_qualifier: str = Field(None, description="The CDM event qualifier, which corresponds to the outcome of the isEvent qualification logic which qualifies the lifecycle event as a function of its features (e.g. PartialTermination, ClearingSubmission, Novation, ...).")
    after: List[ForwardRef("TradeState")] = Field(None, description="Specifies the after trade state(s) created.")
