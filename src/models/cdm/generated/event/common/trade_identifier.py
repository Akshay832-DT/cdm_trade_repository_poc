...
class TradeIdentifier(CdmModelBase):
    ...
    identifier_type: ForwardRef("TradeIdentifierTypeEnum") = Field(None, description="The enumerated classification of the identifier. Optional as a trade identifier may be party-specific, in which case it may not correspond to any established classification.")
