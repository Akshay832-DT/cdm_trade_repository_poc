...
class FieldWithMetaMasterConfirmationTypeEnum(CdmModelBase):
    """"""
    value: ForwardRef("MasterConfirmationTypeEnum") = Field(None)
    meta: ForwardRef("MetaFields") = Field(None)

# Import after class definition to avoid circular imports
from src.models.cdm.generated.legaldocumentation.master.master_confirmation_type_enum import MasterConfirmationTypeEnum
from src.models.cdm.generated.metafields.meta_fields import MetaFields
FieldWithMetaMasterConfirmationTypeEnum.model_rebuild()
