...
class FieldWithMetaCommodityBusinessCalendarEnum(CdmModelBase):
    """"""
    value: ForwardRef("CommodityBusinessCalendarEnum") = Field(None)
    meta: ForwardRef("MetaFields") = Field(None)

# Import after class definition to avoid circular imports
from src.models.cdm.generated.base.datetime.commodity_business_calendar_enum import CommodityBusinessCalendarEnum
from src.models.cdm.generated.metafields.meta_fields import MetaFields
FieldWithMetaCommodityBusinessCalendarEnum.model_rebuild()
