...
class FieldWithMetaContractualDefinitionsEnum(CdmModelBase):
    """"""
    value: ForwardRef("ContractualDefinitionsEnum") = Field(None)
    meta: ForwardRef("MetaFields") = Field(None)

# Import after class definition to avoid circular imports
from src.models.cdm.generated.legaldocumentation.common.contractual_definitions_enum import ContractualDefinitionsEnum
from src.models.cdm.generated.metafields.meta_fields import MetaFields
FieldWithMetaContractualDefinitionsEnum.model_rebuild()
