...
class FieldWithMetaNonNegativeQuantitySchedule(CdmModelBase):
    """"""
    value: ForwardRef("NonNegativeQuantitySchedule") = Field(None)
    meta: ForwardRef("MetaFields") = Field(None)

# Import after class definition to avoid circular imports
from src.models.cdm.generated.base.math.non_negative_quantity_schedule import NonNegativeQuantitySchedule
from src.models.cdm.generated.metafields.meta_fields import MetaFields
FieldWithMetaNonNegativeQuantitySchedule.model_rebuild()
