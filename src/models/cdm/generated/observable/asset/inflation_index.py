...
class InflationIndex(CdmModelBase):
    ...
    inflation_rate_index: ForwardRef("FieldWithMetaInflationRateIndexEnum") = Field(description="The reference index that is used to specify the inflation interest rate.")
