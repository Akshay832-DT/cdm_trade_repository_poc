...
class EligibleCollateralCriteria(CdmModelBase):
    ...
    treatment: ForwardRef("CollateralTreatment") = Field(description="Identifies the treatment of specified collateral, e.g., haircuts,holding limits or exclusions.")
...
from src.models.cdm.generated.product.collateral.collateral_treatment import CollateralTreatment
from src.models.cdm.generated.product.collateral.rating_priority_resolution_enum import RatingPriorityResolutionEnum
EligibleCollateralCriteria.model_rebuild()
