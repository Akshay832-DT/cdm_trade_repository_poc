...
class UnderlyingInstrumentComponent(FIXComponentBase):
    ...
    UndSecAltIDGrp: Optional[UndSecAltIDGrpComponent] = Field(None, description='UndSecAltIDGrp component')
    UnderlyingStipulations: Optional[UnderlyingStipulationsComponent] = Field(None, description='UnderlyingStipulations component')
