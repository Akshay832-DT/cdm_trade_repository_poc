"""
FIX 4.4 LegOrdGrp Component

This module contains the Pydantic model for the LegOrdGrp component.
"""
...
from src.models.fix.generated.components.legpreallocgrp import LegPreAllocGrp
...
class LegOrdGrp(FIXMessageBase):
    """
    FIX 4.4 LegOrdGrp Component
    """
    model_config = ConfigDict(
    ...
    legPreAllocGrp: Optional[LegPreAllocGrp] = Field(None, description='LegPreAllocGrp component')
