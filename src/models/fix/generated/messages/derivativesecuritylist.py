...
from src.models.fix.generated.components.relsymderivsecgrp import RelSymDerivSecGrpComponent
...
class DerivativeSecurityList(FIXMessageBase):
    ...
    RelSymDerivSecGrp: Optional[RelSymDerivSecGrpComponent] = Field(None, description='RelSymDerivSecGrp component')
