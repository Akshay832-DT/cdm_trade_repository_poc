"""
FIX SecurityListRequest Message
"""
...
class SecurityListRequestMessage(FIXMessageBase):
    ...
    MsgType: Literal["SecurityListRequest"] = Field("SecurityListRequest", alias="35", description="Message Type")
...
SecurityListRequestMessage.model_rebuild()
