...
class OrderMassCancelReport(TradeModel):
    ...
    MassCancelResponse: str = Field(None, description='', alias='531')
    ...
    AffectedOrdGrp: Optional[AffectedOrdGrp] = None
