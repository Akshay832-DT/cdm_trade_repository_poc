"""FIX message model for CollateralReport (BA).
...
class CollateralReportMessage(FIXMessageBase):
    """FIX message model for CollateralReport."""

    MsgType: str = Field("BA", alias="35")

    CollRptID: str = Field(..., alias='908', description='')
    CollInquiryID: Optional[str] = Field(None, alias='909', description='')
    CollStatus: int = Field(..., alias='910', description='')
