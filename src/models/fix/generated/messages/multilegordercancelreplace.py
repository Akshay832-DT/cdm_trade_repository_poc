"""
FIX 4.4 MultilegOrderCancelReplace Message

This module contains the Pydantic model for the MultilegOrderCancelReplace message.
"""
...
from ..components.legordgrp import LegOrdGrp
...
from ..components.preallocmleggrp import PreAllocMlegGrp
from ..components.trdgsesgrp import TrdgSesGrp
from ..components.undinstrmtgrp import UndInstrmtGrp


class MultilegOrderCancelReplace(TradeModel):
    """
    FIX 4.4 MultilegOrderCancelReplace Message
    """
    ...
    MsgType: Literal["AC"] = Field(alias='35')
    ...
    PreAllocMlegGrp: Optional[PreAllocMlegGrp] = None
