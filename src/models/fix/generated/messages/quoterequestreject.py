...
from ..components.quotreqrjctgrp import QuotReqRjctGrp


class QuoteRequestReject(TradeModel):
    """
    FIX 4.4 QuoteRequestReject Message
    """
    ...
    MsgType: Literal["AG"] = Field(alias='35')
    ...
    QuoteRequestRejectReason: int = Field(None, description='', alias='658')
