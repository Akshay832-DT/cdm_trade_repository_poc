...
from src.models.fix.generated.components.legquotstatgrp import LegQuotStatGrpComponent
...
class QuoteStatusReport(FIXMessageBase):
    ...
    LegQuotStatGrp: Optional[LegQuotStatGrpComponent] = Field(None, description='LegQuotStatGrp component')
