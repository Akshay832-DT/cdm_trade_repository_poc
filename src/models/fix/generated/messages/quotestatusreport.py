...
LegQuotStatGrpComponent = ForwardRef('LegQuotStatGrpComponent')
...
class QuoteStatusReportMessage(FIXMessageBase):
    ...
    MsgType: Literal["QuoteStatusReport"] = Field("QuoteStatusReport", alias="35", description="Message Type")
    ...
    LegQuotStatGrp: ForwardRef('LegQuotStatGrpComponent') = Field(None, description="LegQuotStatGrp Component")
    ...
    def __str__(self) -> str:
        ...
        if self.LegQuotStatGrp is not None:
            fields.append(f"LegQuotStatGrp={self.LegQuotStatGrp}")
...
QuoteStatusReportMessage.model_rebuild()
