...
from ..components.legquotstatgrp import LegQuotStatGrp
...
class QuoteStatusReport(TradeModel):
    """
    FIX 4.4 QuoteStatusReport Message
    """
    ...
    MsgType: Literal["AI"] = Field(alias='35')
    ...
    LegQuotStatGrp: Optional[LegQuotStatGrp] = None
