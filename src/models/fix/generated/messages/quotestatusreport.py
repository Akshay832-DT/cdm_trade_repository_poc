"""
FIX 4.4 QuoteStatusReport Message

This module contains the Pydantic model for the QuoteStatusReport message.
"""
...
from src.models.fix.generated.components.legquotstatgrp import LegQuotStatGrp
...
class QuoteStatusReport(FIXMessageBase):
    """
    FIX 4.4 QuoteStatusReport Message
    """
    ...
    msgType: Literal["AI"] = Field("AI", alias='35')
    ...
    legQuotStatGrp: Optional[LegQuotStatGrp] = Field(None, description='LegQuotStatGrp component')
