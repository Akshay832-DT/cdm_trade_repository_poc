"""
FIX OrderCancelReplaceRequest Message
"""
...
class OrderCancelReplaceRequestMessage(FIXMessageBase):
    ...
    MsgType: Literal["OrderCancelReplaceRequest"] = Field("OrderCancelReplaceRequest", alias="35", description="Message Type")
...
OrderCancelReplaceRequestMessage.model_rebuild()
