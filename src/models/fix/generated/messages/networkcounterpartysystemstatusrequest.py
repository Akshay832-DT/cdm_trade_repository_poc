...
from ..components.compidreqgrp import CompIDReqGrp


class NetworkCounterpartySystemStatusRequest(TradeModel):
    """
    FIX 4.4 NetworkCounterpartySystemStatusRequest Message
    """
    ...
    MsgType: Literal["BC"] = Field(alias='35')
    ...
    NetworkRequestType: int = Field(None, description='', alias='935')
    NetworkRequestID: str = Field(None, description='', alias='933')
    CompIDReqGrp: Optional[CompIDReqGrp] = None
