"""
FIX CollateralAssignment Message
"""
...
class CollateralAssignmentMessage(FIXMessageBase):
    ...
    MsgType: Literal["CollateralAssignment"] = Field("CollateralAssignment", alias="35", description="Message Type")
    ...
    CollAsgnRefID: Optional[str] = Field(None, alias="907", description="")
    ...
    def __str__(self) -> str:
        ...
        if self.CollAsgnRefID is not None:
            fields.append(f"CollAsgnRefID={self.CollAsgnRefID}")
...
CollateralAssignmentMessage.model_rebuild()
