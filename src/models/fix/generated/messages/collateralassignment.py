"""FIX message model for CollateralAssignment (AY).
...
class CollateralAssignmentMessage(FIXMessageBase):
    """FIX message model for CollateralAssignment."""

    MsgType: str = Field("AY", alias="35")
    ...
    CollAsgnTransType: int = Field(..., alias='903', description='')
