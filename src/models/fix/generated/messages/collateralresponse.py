...
class CollateralResponse(FIXMessageBase):
    """
    FIX 4.4 CollateralResponse Message
    """
    ...
    msgType: Literal["AZ"] = Field("AZ", alias='35')
    
    # Message-specific fields
    collRespID: Optional[str] = Field(None, description='', alias='904')
    ...
    collAsgnRespType: Optional[int] = Field(None, description='', alias='905')
