"""
FIX CollateralResponse Message
"""
...
class CollateralResponseMessage(FIXMessageBase):
    ...
    MsgType: Literal["CollateralResponse"] = Field("CollateralResponse", alias="35", description="Message Type")

    CollRespID: Optional[str] = Field(None, alias="904", description="")
    CollAsgnID: Optional[str] = Field(None, alias="902", description="")
    CollReqID: Optional[str] = Field(None, alias="894", description="")
    CollAsgnReason: Optional[int] = Field(None, alias="895", description="")
    CollAsgnTransType: Optional[int] = Field(None, alias="903", description="")
    CollAsgnRespType: Optional[int] = Field(None, alias="905", description="")
    CollAsgnRejectReason: Optional[int] = Field(None, alias="906", description="")
    ...
    def __str__(self) -> str:
        ...
        if self.CollRespID is not None:
            fields.append(f"CollRespID={self.CollRespID}")
        if self.CollAsgnID is not None:
            fields.append(f"CollAsgnID={self.CollAsgnID}")
        ...
        if self.CollAsgnTransType is not None:
            fields.append(f"CollAsgnTransType={self.CollAsgnTransType}")
        if self.CollAsgnRespType is not None:
            fields.append(f"CollAsgnRespType={self.CollAsgnRespType}")
        if self.CollAsgnRejectReason is not None:
            fields.append(f"CollAsgnRejectReason={self.CollAsgnRejectReason}")
...
CollateralResponseMessage.model_rebuild()
