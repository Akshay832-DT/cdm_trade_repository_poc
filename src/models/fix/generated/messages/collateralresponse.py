"""FIX message model for CollateralResponse (AZ).
...
class CollateralResponseMessage(FIXMessageBase):
    """FIX message model for CollateralResponse."""

    MsgType: str = Field("AZ", alias="35")

    CollRespID: str = Field(..., alias='904', description='')
    CollAsgnID: str = Field(..., alias='902', description='')
    ...
    CollAsgnRespType: int = Field(..., alias='905', description='')
