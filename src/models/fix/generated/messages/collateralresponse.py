"""
FIX 4.4 CollateralResponse Message

This module contains the Pydantic model for the CollateralResponse message.
"""
...
from ..components.undinstrmtcollgrp import UndInstrmtCollGrp


class CollateralResponse(TradeModel):
    """
    FIX 4.4 CollateralResponse Message
    """
    ...
    MsgType: Literal["AZ"] = Field(alias='35')
    ...
    CollRespID: str = Field(None, description='', alias='904')
    CollAsgnID: str = Field(None, description='', alias='902')
    CollReqID: Optional[str] = Field(None, description='', alias='894')
    CollAsgnReason: int = Field(None, description='', alias='895')
    CollAsgnTransType: Optional[int] = Field(None, description='', alias='903')
    CollAsgnRespType: int = Field(None, description='', alias='905')
    CollAsgnRejectReason: Optional[int] = Field(None, description='', alias='906')
    ...
    UndInstrmtCollGrp: Optional[UndInstrmtCollGrp] = None
