"""
FIX DerivativeSecurityListRequest Message
"""
...
class DerivativeSecurityListRequestMessage(FIXMessageBase):
    ...
    MsgType: Literal["DerivativeSecurityListRequest"] = Field("DerivativeSecurityListRequest", alias="35", description="Message Type")

    SecurityReqID: Optional[str] = Field(None, alias="320", description="")
    SecurityListRequestType: Optional[int] = Field(None, alias="559", description="")
    ...
    def __str__(self) -> str:
        ...
        if self.SecurityListRequestType is not None:
            fields.append(f"SecurityListRequestType={self.SecurityListRequestType}")
...
DerivativeSecurityListRequestMessage.model_rebuild()
