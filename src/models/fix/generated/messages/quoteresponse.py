...
class QuoteResponseMessage(FIXMessageBase):
    ...
    MsgType: Literal["QuoteResponse"] = Field("QuoteResponse", alias="35", description="Message Type")

    QuoteRespID: Optional[str] = Field(None, alias="693", description="")
    QuoteID: Optional[str] = Field(None, alias="117", description="")
    QuoteRespType: Optional[int] = Field(None, alias="694", description="")
    ...
    def __str__(self) -> str:
        ...
        if self.QuoteRespType is not None:
            fields.append(f"QuoteRespType={self.QuoteRespType}")
...
QuoteResponseMessage.model_rebuild()
