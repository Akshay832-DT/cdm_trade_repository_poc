"""
FIX 4.4 AllocationInstruction Message

This module contains the Pydantic model for the AllocationInstruction message.
"""
...
class AllocationInstruction(TradeModel):
    """
    FIX 4.4 AllocationInstruction Message
    """
    ...
    AllocType: int = Field(None, description='', alias='626')
