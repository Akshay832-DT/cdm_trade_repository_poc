...
class AllocationReportMessage(FIXMessageBase):
    ...
    MsgType: Literal["AllocationReport"] = Field("AllocationReport", alias="35", description="Message Type")
    ...
    def __str__(self) -> str:
        ...
        if self.AllocReportRefID is not None:
            fields.append(f"AllocReportRefID={self.AllocReportRefID}")
...
AllocationReportMessage.model_rebuild()
