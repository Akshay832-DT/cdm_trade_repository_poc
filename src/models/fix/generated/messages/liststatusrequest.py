...
class ListStatusRequestMessage(FIXMessageBase):
    ...
    MsgType: Literal["ListStatusRequest"] = Field("ListStatusRequest", alias="35", description="Message Type")
...
ListStatusRequestMessage.model_rebuild()
