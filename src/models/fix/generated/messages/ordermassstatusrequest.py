...
class OrderMassStatusRequest(TradeModel):
    """
    FIX 4.4 OrderMassStatusRequest Message
    """
    ...
    MsgType: Literal["AF"] = Field(alias='35')
    ...
    MassStatusReqID: str = Field(None, description='', alias='584')
    MassStatusReqType: int = Field(None, description='', alias='585')
