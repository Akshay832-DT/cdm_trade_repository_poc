"""
FIX AllocationInstructionAck Message
"""
...
class AllocationInstructionAckMessage(FIXMessageBase):
    ...
    MsgType: Literal["AllocationInstructionAck"] = Field("AllocationInstructionAck", alias="35", description="Message Type")
...
AllocationInstructionAckMessage.model_rebuild()
