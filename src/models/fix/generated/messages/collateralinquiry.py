...
class CollateralInquiryMessage(FIXMessageBase):
    ...
    MsgType: Literal["CollateralInquiry"] = Field("CollateralInquiry", alias="35", description="Message Type")
...
CollateralInquiryMessage.model_rebuild()
