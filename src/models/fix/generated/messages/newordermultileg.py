...
class NewOrderMultilegMessage(FIXMessageBase):
    ...
    MsgType: Literal["NewOrderMultileg"] = Field("NewOrderMultileg", alias="35", description="Message Type")
...
NewOrderMultilegMessage.model_rebuild()
