"""
FIX 4.4 Reject Message

This module contains the Pydantic model for the Reject message.
"""
...
class Reject(TradeModel):
    ...
    MsgType: Literal["3"] = Field(alias='35')
    ...
    RefSeqNum: int = Field(None, description='', alias='45')
