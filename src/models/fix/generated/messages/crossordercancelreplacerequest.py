"""
FIX CrossOrderCancelReplaceRequest Message
"""
...
class CrossOrderCancelReplaceRequestMessage(FIXMessageBase):
    ...
    MsgType: Literal["CrossOrderCancelReplaceRequest"] = Field("CrossOrderCancelReplaceRequest", alias="35", description="Message Type")
...
CrossOrderCancelReplaceRequestMessage.model_rebuild()
