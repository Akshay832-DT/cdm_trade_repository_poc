...
class TradeCaptureReportRequestAck(TradeModel):
    """
    FIX 4.4 TradeCaptureReportRequestAck Message
    """
    ...
    MsgType: Literal["AQ"] = Field(alias='35')
    ...
    TradeRequestResult: int = Field(None, description='', alias='749')
    TradeRequestStatus: int = Field(None, description='', alias='750')
